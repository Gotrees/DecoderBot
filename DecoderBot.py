...
REPLYSTRING = "You have awarded one point to _parent_ and marked this post as solved."
#This is the phrase that User will receive
#_parent_ will be replaced by the username of the Parent.
EXEMPT = ["nottoda", "iamatravellover", "gotrees", "onewordpizza","BeerGeekAlpha","oirokenojutsu","wish5138008"]
...
EXPLAINREPLY = "Sorry, but " + str(MAXPERTHREAD) + " point has already been distributed in this thread. This is the maximum allowed at this time."
...
LEADERBOARDHEADER = "\n\n[Our top decoders:](http://www.reddit.com/r/Decoders/wiki/leaderboard#lb)\n\nRank | Username | Points\n-: | :- | -:"
								...
								if OPONLY == False or cauthor == op or cauthor in MODERATORS:
									...
									if fetched < MAXPERTHREAD:
										if flair(subreddit, pauthor):
											...
											comment.submission.set_flair('Solved' .format('Solved'), "Solved")
...
def updateleaders(subreddit):
	...
	now = getTime(False)
	now = datetime.datetime.strftime(now, "Last updated: "+"%B %d %Y, %H:%M UTC")
